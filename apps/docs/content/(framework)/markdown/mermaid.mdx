...
<include cwd meta='title="src/components/mdx/mermaid.tsx"'>
...
```tsx title="src/components/mdx/mermaid.tsx"
import { CodeBlock, Pre } from 'fumadocs-ui/src/components/codeblock';
...
import { Mermaid } from '@/src/components/mdx/mermaid'; // [!code ++]
